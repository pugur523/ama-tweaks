...
public class Configs implements IConfigHandler
{
    ...
    {
        public static final ConfigStringList HOTBAR_RESTOCK_LIST = new ConfigStringList("hotbarRestockList", ImmutableList.of("minecraft:fireworks_rocket", "minecraft:golden_carrot"), "item list to restock with tweakHotbarRestock");
